...
namespace Stride.LauncherApp.Services
{
    public static class LauncherSettings
    {
        ...
        private static readonly SettingsKey<string> PreferredFrameworkKey = new SettingsKey<string>("Internal/Launcher/PreferredFramework", SettingsContainer, defaultValue: "net6.0");
