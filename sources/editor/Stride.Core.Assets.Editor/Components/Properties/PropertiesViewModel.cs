...
{
    /// <summary>
    ///   Represents a view model that manages the construction of a <see cref="GraphViewModel"/> of a
    ...
    public abstract class PropertiesViewModel : DispatcherViewModel
    {
        ...
        {
            get => viewModel;
            private set => SetValue(ref viewModel, value);
        }

        public bool CanDisplayProperties
        {
            get => canDisplayProperties;
            set => SetValue(ref canDisplayProperties, value);
        }

        public string FallbackMessage
        {
            get => fallbackMessage;
            set => SetValue(ref fallbackMessage, value);
        }
        ...
        public async Task<GraphViewModel> GenerateSelectionPropertiesAsync(IEnumerable<IPropertyProviderViewModel> selectedObjects)
        {
            ...
            if (!CanDisplaySelectedObjects(Selection, out string message))
            {
                ViewModel = null;
