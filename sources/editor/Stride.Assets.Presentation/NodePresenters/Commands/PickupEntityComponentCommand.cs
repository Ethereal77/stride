...
namespace Xenko.Assets.Presentation.NodePresenters.Commands
{
    public class PickupEntityComponentCommand : PickupSceneObjectCommandBase
    {
        ...
        {
            var pickerDialog = Session.ServiceProvider.Get<IXenkoDialogService>().CreateEntityComponentPickerDialog((EntityHierarchyEditorViewModel)asset.Editor, targetType);
