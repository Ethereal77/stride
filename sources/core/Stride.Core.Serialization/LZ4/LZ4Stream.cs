...
namespace Stride.Core.LZ4
{
    ...
    public class LZ4Stream : Stream
    {
        ...
        /// <summary>
        /// The high compression flag (compression only).
        /// </summary>
        ...
        /// <summary>
        /// The block size (compression only).
        /// </summary>
        ...
        /// <summary>
        /// The buffer containing the compressed read data</summary>
        private byte[] compressedDataBuffer;

        /// <summary>
        /// The buffer length (can be different then _buffer.Length).
        /// </summary>
