...
namespace Stride.Core
{
    ...
    public static class Utilities
    {
        ...
        /// <para>
        ///   A thin wrapper around <see cref="Unsafe.CopyBlock(void*, void*, uint)"/>.
        /// </para>
        /// </summary>
        ...
        /// <remarks>
        ///   This API corresponds to the <c>unaligned.1 cpblk</c> opcode sequence.
        ///   No alignment assumptions are made about the <paramref name="destination"/> or <paramref name="source"/> pointers.
        /// </remarks>
        ...
        /// <summary>
        /// Suspends the current thread for a duration.
        /// </summary>
        ...
        /// <summary>
        /// Suspends the current thread for a number of milliseconds.
        /// </summary>
