        ...
        private class SemaphoreW
        {
            ...
            private struct Internals
            {
                    ...
                    do
                    {
                        ...
                        else if (timeoutMs != 0)
                        {
                            ...
                            else
                            {
                                ...
                                // Overflow check: This many waiters is currently not supported
                                Debug.Assert(newCounts.WaiterCount != 0);
                            }
                        }
                ...
                private static void Spin(int spinIndex, int sleep0Threshold)
                {
                    ...
                    //    busy-wait that may quickly reach the max spin count and cause the thread to enter a wait state. Completing the
                    ...
                    if (!isSingleCore && (spinIndex < sleep0Threshold || (spinIndex - sleep0Threshold) % 2 != 0))
                    {
