...
{
    /// <summary>
    /// Determines whether two sequences are equal. Comparing the elements is done using the default equality comparer for their type.
    /// <para>Allows either parameter to be <c>null</c>.</para>
    /// <para>A thin wrapper around <see cref="Enumerable.SequenceEqual{TSource}(IEnumerable{TSource}, IEnumerable{TSource})"/>.
    /// </para></summary>
    ...
    /// <summary>
    /// Determines whether two sequences are equal. Comparing the elements is done using the specified equality comparer.
    /// <para>Allows <paramref name="first"/> and/or <paramref name="second"/> to be <c>null</c>.</para>
    /// <para>A thin wrapper around <see cref="Enumerable.SequenceEqual{TSource}(IEnumerable{TSource}, IEnumerable{TSource}, IEqualityComparer{TSource}?)"/>.
    /// </para></summary>
    /// <typeparam name="T">The type of the elements of the input sequences.</typeparam>
    /// <param name="first">An enumerable to compare to <paramref name="second"/>.</param>
    /// <param name="second">An enumerable to compare to <paramref name="first"/>.</param>
