...
namespace Stride.PackageInstall
{
    class Program
    {
        private static readonly (string Id, string Name)[] NecessaryVS2019Workloads = new[]
        {
        ...
        private static void CheckVisualStudioAndBuildTools()
        {
            ...
            else
            {
                ...
                if (AllowVisualStudioOnly && existingVisualStudio2019Install != null && File.Exists(vsInstallerPath))
                {
                    ...
                    if (existingVisualStudio2019Install != null && !existingVisualStudio2019Install.IsComplete)
