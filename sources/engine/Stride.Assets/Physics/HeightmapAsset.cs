...
namespace Stride.Assets.Physics
{
    ...
    public partial class HeightmapAsset : AssetWithSource
    {
        ...
        /// <summary>
        ///   Parameters to convert pixel values to heights.
        /// </summary>
        [DataMember(10)]
        ...
        /// </summary>
        /// <remarks>
        ///   By default, they are considered to be in the range [-1 .. 1] when the pixel format of the image
        ///   file is in a floating-point component format.
        ...
        /// </summary>
        /// <remarks>
        ///   Enable if the R components are signed short integer in the range [-32767 .. 32767].
