...
namespace Stride.Physics
{
    ...
    public class Heightmap
    {
        ...
        /// <summary>
        ///   The underlying type used to represent the height values.
        /// </summary>
        [DataMember(40)]
        [Display(Browsable = false)]
        ...
        ///   Positive and negative heights can not be handled at the same time when the height type is Byte.
        /// </remarks>
        [DataMember(60)]
        public Vector2 HeightRange;

        /// <summary>
        ///   Used to calculate the height when the height type is Short or Byte. HeightScale should be 1 when
        ///   the height type is Float.
        /// </summary>
        [DataMember(70)]
        ...
        public static Heightmap Create<T>(Int2 size, HeightfieldTypes heightType, Vector2 heightRange, float heightScale, T[] data)
        {
            ...
            switch (data)
            {
                ...
                default:
                    throw new ArgumentException($"{ typeof(T[]) } is not supported in { heightType } height type. Or { nameof(data) }.{ nameof(data).Length } doesn't match { nameof(size) }.");
            }
