...
namespace Stride.Physics
{
    public class Simulation : IDisposable
    {
        ...
        /// <param name="to">The ending point of the ray.</param>
        ...
        /// <param name="from">The starting point of the sweep.</param>
        /// <param name="to">The ending point of the sweep.</param>
        /// <param name="filterGroup">The collision group of this sweep.</param>
        /// <param name="filterFlags">The collision group the sweep can collide with.</param>
        /// <returns>The hit results.</returns>
