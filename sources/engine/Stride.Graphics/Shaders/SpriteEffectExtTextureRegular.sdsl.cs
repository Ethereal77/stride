...
{
    public static partial class SpriteEffectExtTextureRegularKeys
    {
        public static readonly ObjectParameterKey<Texture> TextureRegular = ParameterKeys.NewObject<Texture>();
