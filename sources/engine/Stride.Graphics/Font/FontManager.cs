...
{
    /// <summary>
    ///   Represents a font manager, a system in charge of loading TrueType font files, looking for font informations,
    ///   rendering and caching the <see cref="CharacterBitmap"/>s on the CPU.
    /// </summary>
