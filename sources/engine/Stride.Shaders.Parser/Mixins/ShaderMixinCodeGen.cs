...
namespace Xenko.Shaders.Parser.Mixins
{
    ...
    {
        private const string DefaultNameSpace = "Xenko.Rendering";
        ...
        public override bool Run()
        {
            ...
            WriteLine("// To generate it yourself, please install Xenko.VisualStudio.Package .vsix");
            ...
            WriteLine("using Xenko.Core;");
            WriteLine("using Xenko.Rendering;");
            WriteLine("using Xenko.Graphics;");
            WriteLine("using Xenko.Shaders;");
            WriteLine("using Xenko.Core.Mathematics;");
            WriteLine("using Buffer = Xenko.Graphics.Buffer;");
            WriteLine();
