...
{
    /// <summary>
    ///   Represents a visitor that walks over the Syntax Tree and look for any "Link" annotation in order to
    ///   bind EffectVariables to their associated HLSL variables.
    /// </summary>
    internal class ShaderLinker : ShaderWalker
    {
        ...
        public override void Visit(MethodDefinition method)
        {
            ...
            if (streamOutputAttribute != null)
            {
                ...
                StreamOutputParser.Parse(effectReflection.ShaderStreamOutputDeclarations, out int[] streamOutputStrides, streamOutputAttribute, ((StructType)FindDeclaration("GS_OUTPUT")).Fields);
