...
{
    /// <summary>
    ///   Represents a post-processing image effect that applies a light-streaks effect to an image.
    /// </summary>
    /// <remarks>
    ///   This image effect takes as input a bright-pass buffer, calculates the light-streaks and blends them
    ...
    public class LightStreak : ImageEffect
    {
        ...
        /// <summary>
        ///   Gets or sets the amount (intensity) of the light streaks.
        /// </summary>
        ...
        /// <summary>
        ///   Gets or sets the number of light streaks.
        /// </summary>
        ...
        public int StreakCount
        {
            ...
            set
            {
                if (value <= 0)
                    value = 0;
                if (value > StreakMaxCount)
                    value = StreakMaxCount;
        ...
        /// <summary>
        ///   Gets or sets the number of stretching iterations to apply.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///   Gets or sets the number of texture taps for each iteration of light streak extension.
        /// </summary>
        [DataMemberIgnore]
        public int TapsPerIteration
        {
            get => tapsPerIteration;
        ...
        /// <summary>
        ///   Gets or sets a value that determines how fast the attenuation is along a streak, affecting the streak length.
        /// </summary>
        ...
        /// <summary>
        ///   Gets or sets the phase angle for the streaks, in degrees.
        /// </summary>
        ...
        /// <summary>
        ///   Gets or sets the RGB coefficients to apply for color aberration along a streak.
        /// </summary>
        [DataMemberIgnore]
        public Vector3 ColorAberrationCoefficients { get; set; }

        /// <summary>
        ///   Gets or sets the strength of the color aberration.
        /// </summary>
        /// <userdoc>The strength of the color aberrations visible along the streak.</userdoc>
        [Display("Color aberration")]
        [DataMember(50)]
        [DefaultValue(0.2f)]
        ...
        /// <summary>
        ///   Gets or sets a value indicating whether to appliy an anamorphic effect to the streak.
        /// </summary>
        ...
        public bool IsAnamorphic
        {
            ...
            set
            {
                ...
                if (!isAnamorphic)
                {
                    AnamorphicOffsetsWeights = new[] { new Vector3(0f, 0f, 1f) };
                }
                else
                {
                    AnamorphicOffsetsWeights = new[]
                        {
        ...
        /// <summary>
        ///   Gets or sets the offsets and weights for the drawing of sub-light-streaks rendered at a certain offset
        ///   of each light streak and with a certain weight.
        /// </summary>
        [DataMemberIgnore]
        ...
        protected override void DrawCore(RenderDrawContext contextParameters)
        {
            ...
            if (input is null || StreakCount == 0 || IterationCount == 0)
                return;
            ...
            Vector2 direction;
            Texture currentInput, currentOutput = null;
