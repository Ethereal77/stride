...
namespace Stride.Rendering.Voxels
{
    public class VoxelStorageTextureClipmap : IVoxelStorageTexture
    {
        ...
        public Texture ClipMaps = null;
        public Texture MipMaps = null;
        public Texture[] TempMipMaps = null;
        ...
        ComputeEffect.ComputeEffectShader VoxelMipmapSimple;

        // NOTE: Memory leaks if the ThreadGroupCounts / Numbers / Composition changes (I suppose due to recompiles...?)
        //       so instead cache them as seperate shaders.
        ComputeEffect.ComputeEffectShader[][] VoxelMipmapSimpleGroups;
        ...
        public void PostProcess(RenderDrawContext drawContext, ShaderSource[] mipmapShaders)
        {
            ...
            {
                VoxelMipmapSimple = new ComputeEffect.ComputeEffectShader(drawContext.RenderContext) { ShaderSourceName = "Voxel2x2x2MipmapEffect" };
            }
                ...
                VoxelMipmapSimpleGroups[0].Length != TempMipMaps.Length)
            {
                ...
                for (int axis = 0; axis < LayoutSize; axis++)
                {
                    ...
                    {
                        VoxelMipmapSimpleGroups[axis][i] = new ComputeEffect.ComputeEffectShader(drawContext.RenderContext) { ShaderSourceName = "Voxel2x2x2MipmapEffect" };
                    }
                }
            }
