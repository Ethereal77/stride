...
namespace Stride.Rendering.Voxels
{
    ...
    public class VoxelStorageClipmaps : IVoxelStorage
    {
        ...
        {
            [Display("Single Clipmap")]
            SingleClipmap,

            [Display("All Clipmaps (Geometry Shader)")]
            AllClipmapsGeometryShader,

            [Display("All Clipmaps (Multiple Renders)")]
            AllClipmapsMultipleRenders
        };
        ...
        Graphics.Buffer FragmentsBuffer = null;
        ...
        {
            return i == ClipMapCurrent ||
                   UpdatesPerFrame != UpdateMethods.SingleClipmap ||
                   (i >= ClipMapCount && ClipMapCurrent == ClipMapCount - 1);
        }
        ...
        public void CollectVoxelizationPasses(ProcessedVoxelVolume data, VoxelStorageContext storageContext)
        {
            ...
            {
                // NOTE: Having trouble with shadow culling when this is enabled - currently performed in vertex shader instead
        ...
        ComputeEffect.ComputeEffectShader BufferToTexture;
        ComputeEffect.ComputeEffectShader BufferToTextureColumns;
        ComputeEffect.ComputeEffectShader ClearBuffer;
        ...
        public void PostProcess(VoxelStorageContext storageContext, RenderDrawContext drawContext, ProcessedVoxelVolume data)
        {
            ...
            {
                ClearBuffer = new ComputeEffect.ComputeEffectShader(context) { ShaderSourceName = "ClearBuffer" };
                BufferToTexture = new ComputeEffect.ComputeEffectShader(context) { ShaderSourceName = "BufferToTextureEffect" };
                BufferToTextureColumns = new ComputeEffect.ComputeEffectShader(context) { ShaderSourceName = "BufferToTextureColumnsEffect" };
            }
