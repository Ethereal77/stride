...
namespace Stride.Rendering.Voxels
{
    ...
    {
        internal partial class StrideLightingVXGI  : IShaderMixinBuilder
        {
            ...
            {
                ShaderMixinManager.Register("StrideLightingVXGI", new StrideLightingVXGI());
            }
        }
    }
    internal static partial class ShaderMixins
    {
        internal partial class StrideForwardShadingEffectVXGI  : IShaderMixinBuilder
        {
            public void Generate(ShaderMixinSource mixin, ShaderMixinContext context)
            {
                ...
                context.Mixin(mixin, "StrideLightingVXGI");
                if (context.ChildEffectName == "VoxelizeToFragmentsEffect")
                {
                    context.Mixin(mixin, "VoxelizeToFragmentsEffect");
                    return;
                }
            }
            ...
            {
                ShaderMixinManager.Register("StrideForwardShadingEffectVXGI", new StrideForwardShadingEffectVXGI());
            }
        }
    }
}
