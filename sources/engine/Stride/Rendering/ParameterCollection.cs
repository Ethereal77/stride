...
namespace Stride.Rendering
{
    ...
    public class ParameterCollection
    {
        ...
        /// <summary>
        /// Increases <paramref name="value"/> to the next multiple of <see cref="Alignment"/>,
        /// if it is not already a multiple.
        /// <para>
        /// It is blindly assumed <see cref="Alignment"/> is a power of 2.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Computes the buffer size required for a single parameter value
        /// or an array of parameters of the same type.
        /// <para>
        /// This is an incremental size for buffers that contain
