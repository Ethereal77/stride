...
{
    /// <summary>
    ///   Base class for behavior implementations that capture the mouse.
    /// </summary>
        ...
        where TElement : UIElement
    {
        ...
        public bool UsePreviewEvents { get { return (bool) GetValue(UsePreviewEventsProperty); } set { SetValue(UsePreviewEventsProperty, value.Box()); } }
        ...
        protected bool AreModifiersValid()
        {
            return Modifiers is null ||
                   (Modifiers == ModifierKeys.None ? Keyboard.Modifiers == ModifierKeys.None : Keyboard.Modifiers.HasFlag(Modifiers));
        }
