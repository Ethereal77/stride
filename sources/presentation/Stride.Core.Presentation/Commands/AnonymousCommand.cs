...
{
    /// <summary>
    ///   Represents an implementation of <see cref="CommandBase"/> that routes <see cref="Execute"/> calls to a given anonymous method.
    /// </summary>
    ...
    public class AnonymousCommand : CommandBase
    {
        ...
        /// <remarks>
        ///   Returns <c>true</c> if <see cref="CommandBase.IsEnabled"/> is <c>true</c> and either a <see cref="Func{Bool}"/>
    ...
    /// <summary>
    ///   Represents an implementation of <see cref="CommandBase"/> that routes <see cref="AnonymousCommand.Execute(object)"/> calls to a given anonymous task.
    /// </summary>
    /// <seealso cref="AnonymousCommand{T}"/>
    public class AnonymousTaskCommand : AnonymousCommand
    {
        ...
        /// </summary>
        /// <param name="serviceProvider">A service provider that can provide a <see cref="Services.IDispatcherService"/> to use for this view model.</param>
        /// <param name="task">A method returning a <see cref="Task"/> that will be called each time the command is executed.</param>
        /// <param name="canExecute">An anonymous method that will be called each time the command <see cref="CommandBase.CanExecute(object)"/> method is invoked.</param>
    ...
    /// <summary>
    ///   Represents an implementation of <see cref="CommandBase"/> that routes <see cref="Execute"/> calls to a given anonymous method with a typed parameter.
    /// </summary>
    ...
    public class AnonymousCommand<T> : CommandBase
    {
        ...
        public override void Execute(object parameter)
        {
            // Allow to make the parameter optional: if not set fall back to the default value
            parameter ??= default(T);
        ...
        /// <returns><c>true</c> if the command can be executed, <c>false</c> otherwise.</returns>
        /// <remarks>
        ///   Returns <c>true</c> if <see cref="CommandBase.IsEnabled"/> is <c>true</c> and either a <see cref="Func{T, Bool}"/>
    ...
    /// <summary>
    ///   Represents an implementation of <see cref="CommandBase"/> that routes <see cref="AnonymousCommand{T}.Execute(object)"/> calls to a given anonymous method with a typed parameter.
    /// </summary>
    /// <typeparam name="T">The type of parameter to use with the command.</typeparam>
